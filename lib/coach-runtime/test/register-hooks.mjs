...
const PKG_ROOT = {
  ...
  "@workspace/coach-data": "../../coach-data",
  "@workspace/coach-scan": "../../coach-scan",
  "@workspace/coach-rank": "../../coach-rank",
  "@workspace/coach-learn": "../../coach-learn",
  "@workspace/coach-cache": "../../coach-cache",
  "@workspace/coach-background": "../../coach-background",
  "@workspace/coach-ticket": "../../coach-ticket",
  "@workspace/coach-alts": "../../coach-alts",
  "@workspace/coach-sim": "../../coach-sim",
  "@workspace/coach-sim-cache": "../../coach-sim-cache",
  "@workspace/coach-gates": "../../coach-gates",
  "@workspace/coach-grade": "../../coach-grade",
  "@workspace/db": "../../db",
};
