...
- For LOW-FREQUENCY YES/NO markets where the line is fixed at 0.5 (HOME RUNS, anytime touchdown, anytime goal scorer, first goal, etc.), the "clears the line" math doesn't apply (a 0.5-line HR avg means homering every other game — almost no player does this). For these markets, you may pick if ANY of the following holds and you cite it: (i) player has ≥2 of that stat in the last 10 games shown, OR (ii) player has the stat at least once in the vs-opponent sample, OR (iii) a clear hot-streak / role indicator (recent multi-game streak, top-3 spot in the order vs RHP/LHP, red-zone usage spike, etc.). Generic price-based or "feels due" reasoning is still banned. If NONE of (i)/(ii)/(iii) is supportable from playerHistory, DROP the leg.
