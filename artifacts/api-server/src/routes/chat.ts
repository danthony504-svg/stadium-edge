...
- An Over Total on a period + a player UNDER prop on the same player that scales with that team's scoring (e.g. "1H Over 115.5" AND "Tatum 1H Points Under 12.5" when Tatum is the team's top scorer — the over likely requires Tatum to deliver).
