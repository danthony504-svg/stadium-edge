...
- When you DO use it, cite the specific real number in the edge note (e.g. "Lakers giving up 119.3 PPG and only 5.1 BLK/g — Murray's 28.4 L5 PTS line has real room" or "Steelers D averaging 3.5 sacks/g and 1.2 INT/g — fade Allen's pass-yds over"). Do NOT cite avgPointsAgainst on its own without pairing it to a player-stat reason — the chain must be "opponent's defense profile → player's prop edge".
