...
import { buildHomeSports } from "@/lib/homeSports";
...
function HomeSportFeed({
  ...
  // results). Kept for pull-to-refresh; home "Today's Performance" card is hidden.
  ...
  return (
    <ErrorBoundary FallbackComponent={HomeFeedErrorFallback}>
      ...
      >
        ...
        {/* Static hero — open Coach only; user chooses the ask (no auto-send). */}
