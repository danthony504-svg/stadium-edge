...
echo ""
echo "Before any TestFlight / preview build:"
echo "  bash scripts/verify-dev-no-ota.sh"
echo "  Test in Expo Go + EAS development profile (EXPO_PUBLIC_OTA_ENABLED=false)"
echo ""
